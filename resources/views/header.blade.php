...
<!-- Bootstrap core CSS     -->
    ...
    <body>
        ...
        <div class="sidebar" data-color="blue" data-image="{{ url('/') }}/img/sidebar-1.jpg">
            ...
            <div class="logo">
                <img class="img-responsive" width="200" height="200" src="{{ url('/') }}/wp-content/themes/escrowcustodianservices/images/logo.png" alt="Escrow Custodian Services">
                <a href="/" >
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="{{ Route::is('get.tra') ? 'active' : '' }}">
                        <a href="{{ route('get.tra') }}">
                            <i class="material-icons">person</i>
                            <p>New Transaction</p>
                        </a>
                    </li>
        ...
        <footer class="footer">
                <div class="container">
                    ...
                    <p class="copyright">
                        &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">Escrow Custodian Services</a>
                    </p>
                </div>
            </footer>
        </div>
