                    ...
                    <div class="authorization authorization--registration">
                        ...
                        <div class="row">
                            <div class="col col--md-auto">
                                ...
                                <form class="authorization__form" enctype="multipart/form-data" accept-charset="UTF-8" role="form" method="post" action="{{ route('auth.register.invite') }}">
                                    ...
                                    <div class="input-wrp {{ ($errors->has('address')) ? 'has-error' : '' }}">
                                        <textarea class="textfield" type="text" name="address" value="" placeholder="Address" required></textarea>
                                    ...
                                    <div class="input-wrp {{ ($errors->has('email')) ? 'has-error' : '' }}">
                                        <input readonly="" class="textfield" name="email" type="text" value="{{ $email }}" placeholder="Email" required />
                                        {!! ($errors->has('email') ? $errors->first('email', '<p class="text-danger">:message</p>') : '') !!}
                                    </div>

                                    <div class="input-wrp {{ ($errors->has('btc')) ? 'has-error' : '' }}">
                                        <input class="textfield" name="email" type="text" placeholder="BTC Address" required />
                                        {!! ($errors->has('btc') ? $errors->first('btc', '<p class="text-danger">:message</p>') : '') !!}
                                    </div>
                                    ...
                                    <h5>Date of Birth</h5>
                                    <p>You must be over 19 to sign a contract</p>
                                    <div class="input-wrp {{ ($errors->has('dob')) ? 'has-error' : '' }}">
                                        <input class="textfield" name="dob" type="date" value="" placeholder="Date Of Birth" required />
                                    ...
                                    <div class="input-wrp {{ ($errors->has('id_pic')) ? 'has-error' : '' }}">
                                        <input readonly="" class="textfield" name="id_pic" type="file" required>
                                        {!! ($errors->has('id_pic') ? $errors->first('id_pic', '<p class="text-danger">:message</p>') : '') !!}
                                    </div>
